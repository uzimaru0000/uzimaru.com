...
var _user$project$Model$GetData = function (a) {
			...
			case 'GetUrl':
				return {
					...
					_1: _user$project$Main$getData(
						A2(_elm_lang$core$Basics_ops['++'], _p0._0, '/post/index.md'))
				};
			case 'GetData':
				if (_p0._0.ctor === 'Ok') {
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		...
		subscriptions: function (_p1) {
			return _user$project$Port$getUrl(_user$project$Model$GetUrl);
		}
	})();
